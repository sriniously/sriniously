...
const components = {
  h1: (props: HeadingProps) => (
    <h1 className="font-semibold text-2xl fade-in" {...props} />
  ),
  h2: (props: HeadingProps) => (
    <h2 className="text-gray-800 text-xl font-medium mt-8 mb-3" {...props} />
  ),
  h3: (props: HeadingProps) => (
    <h3 className="text-gray-800 text-lg font-medium mt-8 mb-3" {...props} />
  ),
  ...
  code: ({ children, ...props }: ComponentPropsWithoutRef<"code">) => {
    const codeHTML = hljs.highlightAuto(children as string, [
      "bash",
      "yaml",
      "javascript",
      "typescript",
