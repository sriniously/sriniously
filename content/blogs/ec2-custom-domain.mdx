...
summary: "In this article, we will learn how to add a custom domain to our EC2 instance with NGINX"
publishedAt: "2022-11-22"
image: /images/ec2-custom-domain/1.png
published: true
---

# Adding custom domain to EC2 instance with NGINX

Now, if you've been following the series and working along, you should already have a working Next.js app running on an EC2 instance. If not, then head over to the [previous article](https://srini-dev.hashnode.dev/deploying-a-next-app-to-aws-ec2-with-github-actions-cicd) where we go through all the steps and all the pre-requisites for hooking up your own custom domain.
...
![Screenshot 2022-11-22 at 8.24.05 PM.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1669128884448/ybPfNUfqc.png align="left")
...
![Screenshot 2022-11-22 at 8.30.26 PM.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1669129242035/YARZ_Pm-D.png align="left")
...
![Screenshot 2022-11-22 at 8.34.35 PM.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1669129484527/571II-YvQ.png align="left")
...
![Screenshot 2022-11-22 at 9.18.30 PM.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1669132120832/vZoRVzz8q.png align="left")
